...
_CONFORMANCE = (
    ...
    ("claude", "PostToolUseFailure", "post_tool_use_failure", WorkLifecycle.FAILED, False),
    ...
    ("grok", "PostToolUseFailure", "post_tool_use_failure", WorkLifecycle.FAILED, False),
    ...
    ("cursor", "postToolUseFailure", "post_tool_use_failure", WorkLifecycle.FAILED, False),
    ...
    ("opencode", "PostToolUseFailure", "post_tool_use_failure", WorkLifecycle.FAILED, False),
